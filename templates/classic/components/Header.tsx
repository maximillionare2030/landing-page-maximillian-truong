      ...
      <div className="container mx-auto px-4 flex h-14 items-center">
        ...
        {config.email && (
          <a
            ...
            className="text-sm font-medium text-muted-foreground hover:text-accent transition-all duration-200 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-sm px-3 py-1 hover:bg-accent/10"
