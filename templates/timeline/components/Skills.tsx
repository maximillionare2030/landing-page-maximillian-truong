...
export function Skills({ config }: SkillsProps) {
  ...
  return (
    <section id="skills" className="container mx-auto px-4 space-y-6 py-8 md:py-12 lg:py-24">
      <div className="mx-auto flex max-w-[1200px] flex-col items-center gap-2">
        <h2 className="text-3xl font-bold leading-tight tracking-tighter md:text-5xl">
          Skills
        </h2>
      </div>
      <div className="mx-auto grid w-full max-w-7xl gap-4 py-6 md:grid-cols-2 lg:grid-cols-3">
